...
"""autogenerated by genpy from text_msgs/bn_pose_srvRequest.msg. Do not edit."""
import codecs
import sys
...
class bn_pose_srvRequest(genpy.Message):
  _md5sum = "f649365150bc105bd0f813c4ed5c63ba"
  _type = "text_msgs/bn_pose_srvRequest"
...
string frame_id
"""
  __slots__ = ['count','total_list','list','image','depth','mask']
  _slot_types = ['int32','int32','int32[]','sensor_msgs/Image','sensor_msgs/Image','sensor_msgs/Image']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       count,total_list,list,image,depth,mask
    ...
    """
    if args or kwds:
      super(bn_pose_srvRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.count, _x.total_list))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.count, _x.total_list,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_BI():
    ...
    return _struct_BI
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from text_msgs/bn_pose_srvResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class bn_pose_srvResponse(genpy.Message):
  _md5sum = "3e002d0c48ed986a47d2a53d72a32f16"
  _type = "text_msgs/bn_pose_srvResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
float64 w
"""
  __slots__ = ['state','count','pix','ob_list']
  _slot_types = ['string','int32','int32','text_msgs/object_pose[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(bn_pose_srvResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2i().pack(_x.count, _x.pix))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.count, _x.pix,) = _get_struct_2i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ob_list = []
...
def _get_struct_i():
    ...
    return _struct_i
class bn_pose_srv(object):
  _type          = 'text_msgs/bn_pose_srv'
  _md5sum = 'a390f42680d4ac2ddfd1904d44d51e95'
  _request_class  = bn_pose_srvRequest
  _response_class = bn_pose_srvResponse
