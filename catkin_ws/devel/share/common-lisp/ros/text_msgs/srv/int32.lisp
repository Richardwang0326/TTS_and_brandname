...
(cl:defmethod cl:initialize-instance :after ((m <int32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'int32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name text_msgs-srv:<int32-request> is deprecated: use text_msgs-srv:int32-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <int32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'int32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name text_msgs-srv:<int32-response> is deprecated: use text_msgs-srv:int32-response instead.")))
