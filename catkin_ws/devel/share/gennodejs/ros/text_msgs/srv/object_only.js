...
class object_onlyRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type object_onlyRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type object_onlyRequest
    let len;
    let data = new object_onlyRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_onlyRequest(null);
...
class object_onlyResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type object_onlyResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type object_onlyResponse
    let len;
    let data = new object_onlyResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new object_onlyResponse(null);
...
module.exports = {
  Request: object_onlyRequest,
  Response: object_onlyResponse,
  md5sum() { return '1af0bf5105da2ef053fba4cb2b4821cc'; },
  datatype() { return 'text_msgs/object_only'; }
};
